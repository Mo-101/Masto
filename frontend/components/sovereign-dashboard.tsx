...
export default function SovereignDashboard() {
  ...
  const getStatusIcon = (status) => {
    if (!status) return <Activity className="w-4 h-4" />
              ...
              <Card className="bg-gray-800 border-gray-700">
                ...
                <CardContent>
                  <div className={`flex items-center ${getStatusColor(systemStatus.api)}`}>
                    ...
                    <span className="ml-2 capitalize">{systemStatus.api || "Unknown"}</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gray-800 border-gray-700">
                ...
                <CardContent>
                  <div className={`flex items-center ${getStatusColor(systemStatus.firebase)}`}>
                    ...
                    <span className="ml-2 capitalize">{systemStatus.firebase || "Unknown"}</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gray-800 border-gray-700">
                ...
                <CardContent>
                  <div className={`flex items-center ${getStatusColor(systemStatus.ml)}`}>
                    ...
                    <span className="ml-2 capitalize">{systemStatus.ml || "Unknown"}</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gray-800 border-gray-700">
                ...
                <CardContent>
                  <div className={`flex items-center ${getStatusColor(systemStatus.database)}`}>
                    ...
                    <span className="ml-2 capitalize">{systemStatus.database || "Unknown"}</span>
                  </div>
                </CardContent>
              </Card>
            </div>
                    ...
                    recentDetections.slice(0, 5).map((detection) => (
                      <div key={detection.id} className="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                        ...
                        <span className="text-xs text-gray-400">
                          {detection.timestamp ? new Date(detection.timestamp).toLocaleTimeString() : "N/A"}
                        </span>
                      </div>
                    ))
                  ) : (
